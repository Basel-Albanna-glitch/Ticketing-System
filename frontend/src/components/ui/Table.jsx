          ...
          <tr>
            {columns.map((col, i) => {
              ...
              return (
                <th
                  key={i}
                  className="px-4 py-2 text-start text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-300"
                >
                  {sortable ? (
                    <button
                      type="button"
                      onClick={() => onSort(sortKey)}
                      className="inline-flex items-center gap-1 uppercase hover:text-gray-700 dark:hover:text-gray-100"
                    >
                      {label}
