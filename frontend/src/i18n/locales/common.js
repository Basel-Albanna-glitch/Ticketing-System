...
export default {
  en: {
    ...
    'notifications.collaboratorTitle': 'You were added as a collaborator',
    'notifications.todoAssignedTitle': 'To-do assigned to you',
    'notifications.viewTodo': 'View to-do',
    'notifications.appName': 'Hermes',
    'notifications.newTicketTitle': 'New ticket',
    'notifications.licenseExpiryTitle': 'License expiring',
    'notifications.desktopMore': '{n} more new notification(s)',
    'notifications.assignedMore': '{n} more ticket(s) waiting for you',
  ...
  ar: {
    ...
    'notifications.collaboratorTitle': 'تمت إضافتك كمتعاون على تذكرة',
    'notifications.todoAssignedTitle': 'تم إسناد مهمة إليك',
    'notifications.viewTodo': 'عرض المهمة',
    'notifications.appName': 'Hermes',
    'notifications.newTicketTitle': 'تذكرة جديدة',
    'notifications.licenseExpiryTitle': 'ترخيص قارب على الانتهاء',
    'notifications.desktopMore': 'إشعارات جديدة أخرى: {n}',
    'notifications.assignedMore': 'تذاكر أخرى بانتظارك: {n}',
